...
namespace MyAspCoreFinalProject.Controllers
{
    public class BloodGroupController : Controller
    {
        ...
        public BloodGroupController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BloodGroupID,BloodGroupName,Description")] BloodGroup bloodGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BloodGroupID,BloodGroupName,Description")] BloodGroup bloodGroup)
        {
